...
public class AuthorizationServiceLocator extends org.apache.axis.client.Service implements com.vsp.bl.claim.service.authorization.AuthorizationService {
    ...
    private java.lang.String Authorization_address = "http://wasacpt02:9620/eligibility.auth_8.0/services/Authorization";
    ...
    public com.vsp.bl.claim.service.authorization.Authorization getAuthorization(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.vsp.bl.claim.service.authorization.AuthorizationSoapBindingStub _stub = new com.vsp.bl.claim.service.authorization.AuthorizationSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.vsp.bl.claim.service.authorization.Authorization.class.isAssignableFrom(serviceEndpointInterface)) {
                com.vsp.bl.claim.service.authorization.AuthorizationSoapBindingStub _stub = new com.vsp.bl.claim.service.authorization.AuthorizationSoapBindingStub(new java.net.URL(Authorization_address), this);
                _stub.setPortName(getAuthorizationWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://authorization.service.claim.bl.vsp.com", "AuthorizationService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://authorization.service.claim.bl.vsp.com", "Authorization"));
        }
