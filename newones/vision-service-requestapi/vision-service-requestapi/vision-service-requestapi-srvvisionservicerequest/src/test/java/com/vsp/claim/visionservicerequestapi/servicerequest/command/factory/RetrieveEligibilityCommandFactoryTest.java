...
@ContextConfiguration(classes = {
		RetrieveEligibilityCommandFactoryTest.Config.class,
		EligibilityServiceClientImpl.class	
})
public class RetrieveEligibilityCommandFactoryTest {
	...
	@Autowired
	private RetrieveEligibilityCommandFactory factory;
	...
	public void testBuildCommand(){
		RetrieveEligibilityCommand builtCommand = 
				(RetrieveEligibilityCommand) factory.buildCommand();
	...
	public void testBuildCommandBuildsSeperateCommands() {
		RetrieveEligibilityCommand builtCommand = 
				(RetrieveEligibilityCommand) factory.buildCommand();
		((RestCommand)builtCommand).initializeServiceClient(restClient);
		RetrieveEligibilityCommand builtCommandTwo =
				(RetrieveEligibilityCommand) factory.buildCommand();
